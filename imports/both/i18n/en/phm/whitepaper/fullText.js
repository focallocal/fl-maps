...
`
    ...
    {
        title: "Public Happiness Token Introduction",
        code: "PuHaTo",
        fullText: ` 
...
`
    ...
    {
        title: "Educating the Public about Blockchain",
        code: "EdthPu",
        chapterHeading: true,
        fullText: ` 
...
`
    ...
    {
        title: "Current State of Public Understanding",
        code: "CuStof",
        fullText: ` 
...
`
    ...
    {
        title: "Who Defines What is Accepted as ‘Public Happiness’",
        code: "WhDeWh",
        fullText: `
...
`
    ...
    {
        title: "Who can Participate on the Platform",
        code: "WhcaPa",
        fullText: `
...
`
    ...
    {
        title: "Pre-existing Communities with Similar Values",
        code: "PrCowi",
        fullText: `
...
`
    ...
    {
        title: "Decentralised Governance and Voting",
        code: "DeGoan",
        fullText: `
...
`
    ...
    {
        title: "User Behaviour in UX Design",
        code: "UsBein",
        fullText: `
...
`
    ...
    {
        title: "Example Scenario: Outside Collusion",
        code: "ExScOu",
        fullText: ` 
...
`
    ...
    { title: "Security", code: "Securi", fullText: ` `, chapterHeading: true },
    {
...
`
    ...
    {
        title: "Cold Storage and Key Holders",
        code: "CoStan",
        fullText: `
...
`
    ...
    { title: "Marketing Strategy", code: "MarStr", fullText: ` `, chapterHeading: true },
    {
        title: "A New Level of Hash Tagging",
        code: "ANewLe",
        fullText: `
...
`
    ...
    {
        title: "Public Happiness Channel",
        code: "PuHaCh",
        fullText: `
...
`
    ...
    {
        title: "Public Happiness Partners",
        code: "PuHaPa",
        fullText: ` 
...
On-boarding existing communities is extremely easy and effective. There are millions around the world already joining in these Public Happiness activities using the blunt traditional social media platforms. We just advise them to withhold the meeting point on those platforms and tell users to join The Public Happiness Platform to find it (along with reasons why). This leads to a near 100% conversion of this community into platform users, where the site is set up to help them participate in that community, rather than to minimise their engagement and maximise clicks. Where they can begin learning about blockchain basics, and earning a token. Where they also become part of a wider and truly global Movement.
...
`
    ...
    {
        title: "Automated Token Distribution Matrix",
        code: "AuToDi",
        chapterHeading: true,
        fullText: `
...
`
    ...
    {
        title: "Further Matrix Considerations",
        code: "FuMaCo",
        fullText: ` 
...
`
    ...
    { title: "Platform Technicals", code: "PlaTec", fullText: ` `, chapterHeading: true },
    {
        title: "Crypto Linking Bridges",
        code: "CrLiBr",
        fullText: `
...
`
    ...
    {
        title: "Switching the Platform to the Dapps Network",
        code: "SwthPl",
        fullText: `
