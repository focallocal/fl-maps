  ...
  <Col className='mb-3' sm='12' md='6' lg='6'>
    ...
    >
      <div style={{ margin: '1.25rem 1.25rem' }}>
        ...
        <CardTitle tag='h5'>
          <CardLink href={item.url} target="_top" target="_top" target="_top">{item.title}</CardLink>
          {/* <Link to={item.url}>
              {item.title}
          </Link> */}
        </CardTitle>
        <CardText style={{ marginTop: '1rem' }}>{item.description}</CardText>
      </div>
      <CardBody>
