    ...
    return (
      <div id='event-info' className={classes}>
        ...
        <div className='first-section'>
          ...
          <Button color='secondary' size="md" block onClick={this.openMoreInfo}>Morsde</Button>
          <img src="https://s.gravatar.com/avatar/e6f3465c1b35161890c8f0eac686692d?s=80" class="rounded" alt="..."/>
          {/*
