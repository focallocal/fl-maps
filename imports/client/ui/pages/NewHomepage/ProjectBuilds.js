          ...
          <div key={index} className="project-card">
            ...
            <div className="project-content">
              ...
              <div className="project-actions">
                <a href={project.see_more_url} className="action-btn see-more-btn" target="_top">{content.see_more_btn || 'See More'}</a>
                <a href={project.tasks_url} className="action-btn tasks-btn" target="_top">{content.tasks_btn || 'Tasks'}</a>
              </div>
            </div>
          </div>
        ))}
