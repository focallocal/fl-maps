      ...
      <section className="upcoming-news-section">
        ...
        <div className="section-column upcoming-column">
          <div className="section-header">
            <h2 className="section-title">{upcomingContent.title || 'Upcoming International Gatherings'}</h2>
            <a href={upcomingContent.see_all_url} className="see-all-link">See All</a>
          </div>
            ...
            <div key={index} className="gathering-card">
              ...
              <div className="gathering-details">
                ...
                <div className="gathering-actions">
                  <a href={item.build_url} className="action-btn build-btn">Build</a>
                  <a href={item.join_url} className="action-btn join-btn">Join</a>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="section-column news-column">
          <div className="section-header">
            <h2 className="section-title">{newsContent.title || 'Latest Community News'}</h2>
            <a href={newsContent.see_all_url} className="see-all-link">See All</a>
          </div>
            ...
            newsItems.map((news, index) => (
              <div key={index} className="news-item">
                ...
                <div className="news-content">
                  ...
                  <a href={news.url} className="read-more-link">Read More →</a>
                </div>
              </div>
            ))
          ) : (
