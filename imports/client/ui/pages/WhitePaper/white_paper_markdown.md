...
* Our ‘profit at all cost’ capitalist economy has failed to provide healthy communities and damaged our planet. It has borrowed from its children's wealth, creating nations where entire generations are largely unable to own a home and a work/life balance pressured into. It offers a balancing effect where over-looked work essential to healthy and happy communities is rewarded fairly. 

* Decentralised Governance in blockchain suffers because players can utilise fiat to buy influence over the eco-system’s direction; or centralised founders hold onto power. We create weighted governance based on contributions to the eco-system’s mission; also opening our governance model up to people outside of the fin-tech community.

* Volunteers by nature contribute a little, then move on. Leaving most volunteer projects constantly training new team members, at the heavy expense of efficiency. The token incentivises and increasingly rewards long-term commitment to good causes, and to the community itself. 
