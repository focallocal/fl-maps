...
The crypto-world has me intensely curious, because money can be different. I wanted to learn more and see if it's possible to make a form of money that was intrinsically tied to creating societal value.  Something like a band-aid on ‘profit at all costs’ capitalism that has blind-spots on large areas critical to a healthy, happy society, due to their foundations measuring success as maximising GDP. Anything which doesn’t is by design an after-thought.

**Intro:**

If the right people get behind this it will have a profound effect on increasing peace, happiness and reducing human-suffering across the world. If you’re reading this it because someone believes that you have the skills to contribute and passion for creating positive change for humanity.

"Those who love peace must learn to organize as effectively as those who love war"  - Martin Luther King.

Note: The paper is very long. The most effective way to contribute is to read the intro, and then click the sections you would most like to contribute to in the contents, and discuss suggestions by clicking the red balloons.

**The world needs this Token and Platform because:**

1. Our ‘profit at all cost’ GDP based economy has failed to provide healthy communities to live in and has damaged our planet. It has borrowed from its children's wealth, creating nations where entire generations are largely unable to own a home and a work/life balance pressured against basic human norms like starting a family.

We provide a balancing effect, where people are rewarded for doing essential work needed to produce healthy and happy communities are rewarded.

2. Decentralised Governance in blockchain suffers because players can utilise fiat to buy influence over the eco-system’s direction and decision making; or centralised founders hold onto power. Undermining the decentralised goals they were founded upon.

We create reputation weighted governance earned through contributions to the eco-system’s mission; also opening our governance model up to people outside of the fin-tech community
...
We incentivise and increasingly reward long-term commitment to positive action for creating a better life on this planet, and to our Public Happiness community itself.

4. Those with beautiful and inspirational ideas for creating a change to benefit humanity lose far, far too much energy chasing funding so they can bring it to the world. Far too many of these ideas falter and fade out at the bitter expense of every human alive, because they lacked the skills and connections to fund bringing their vision to life. 

If their idea convinces the rest of the community on our platform their vision will be funded, shaped, and built in our micro-volunteering hub, by other community members who want to gift it to the world.

5. Social media gave humanity a powerful new tool to collaborate around action in ways never before possible. Where creative ideas and solutions could emerge freely and grow into large scale social events and projects. Then, gradually, they took this tool away. Making it ever more difficult for those ideas to reach an audience unless they were well funded. Big business, celebrity and big charities began dominating reach in a 'pay to play' system while grassroots leaders and ideas struggled and we extinguished. Led by Facebook they cultivated a ‘click and move on’ culture, educating much of the world's population to ever shorter attention spans, as more clicks, faster equals more and as revenue. Then they began listening to our conversations online, and offline. Collecting our location data. Extrapolating and creating data sets of our most personal details to sell to the highest bidder. They facilitated election hacking to undermine our democracies for their own financial benefits. 
...
Focallocal Token is a currency which is intrinsically tied to creating social good. The more its traded, mined and earned, the more our network benefits local communities around the world, building a friendlier, safer and happier future. 
...
4. Our ICO will be used to fund top-level staff to bring their skills in and lead the platforms 1st users to facilitate a smooth growth, until the community is mature enough to self-govern.

5. Teaching users core concepts of the crypto-economic model, our token can operate as a bridge between blockchain and other parts of the non-digital world, through its ability to reach a far broader, and less tech-savvy audience than other coins and tokens. Our platform aims to educate users as to how blockchain will change the world they live in, and how they can understand and interact with it
...
The Token is also mined by taking actions essential to the smooth functioning, and growth of the platform, crypto-economic network, and community (for example, bounty hunting issues, or completing micro-volunteering tasks to build projects).
...
Those who purchase Focallocal Tokens via crowdfunding will receive instructions in how to create a crypto wallet account and guide to storing their Focallocal EC20 tokens – Likely the 1st steps into understanding how to interact with blockchain for many.
...
They will also then be rewarded financially for their future efforts, and selective excellent projects will be offered tokens backdated for activities and projects they’ve created over the last ten years to recognise the effort and personal sacrifice that has gone into creating more well-being in GDP based societies which don’t reward their efforts, and incentivising them to carry on their great work for everyone’s benefit.
...
12.3.
**Remuneration
**The team of experts will be remunerated 50% in Ethereum, and 50% in Focallocal Tokens with the 1st payments coming shortly after the ICO launch and including all work towards the project prior to the ICO .
